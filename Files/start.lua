...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " تيمو"
SudosS = {1931989685}
Sudos = {sudoid,1931989685}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = ' 🇮🇶 ┇ ѕᴏụʀᴄᴇ ᴛɪᴍᴏ',url="t.me/TIMOTTHON"}},
}
}
...
{{text = ' 🇮🇶 ┇ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "تيمو"),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/TIMOTTHON&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  🇮🇶 ┇الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "تيمو"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "تيمو"),"اني لقميل "..(redis:get(bot_id..":namebot") or "تيمو"),(redis:get(bot_id..":namebot") or "تيمو").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "تيمو") then
...
local UserId_Info = bot.searchPublicChat("T_TIMO")
if UserId_Info.id then
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ ᴛɪᴍᴏ\n\n*[ 🇮🇶 ┇  ᴛɪᴍᴏ ᴄʜᴀɴɴᴇʟ](http://t.me/TIMOTTHON)*\n\n*[ 🇮🇶 ┇  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/TIMOTTHON)*\n\n*[ 🇮🇶 ┇  ᴛɪᴍᴏ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/T_TIMO)*\n\n*[ 🇮🇶 ┇  ʙᴏᴛ ᴛɪᴍᴏ](http://t.me/TIMOTTHON)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'ѕᴏụʀᴄᴇ ᴛɪᴍᴏ ',url="t.me/TIMOTTHON"}
