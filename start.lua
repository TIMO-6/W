...
Sudos = {sudoid,1931989685,1931989685}
Sudo_Id = 1931989685
function Bot(msg)  
local idbot = false  
...
if text == "/start" then 
local bl = '*◾أهلا بك في صانع بوتات الحماية 👋🏻 ،\n\n◽البوت مقدم من قناة »* [. Source TIMO >](t.me/APITIMO) \n\n*◾يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[⚙️꒐ Gruop The Suport Maker .](https://t.me/APITIMO)'
...
- تم انشاء الصانع مقدم من قناة ( @APITIMO ) مجاناً 
